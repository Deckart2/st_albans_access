...
subtitle: "St. Albans MLK Day of Reflection<br>January 20, 2026"
author:
  - name: "Gabe Morrison"
...
- Data scientist at the Urban Institute:
  - Build tools to support communities' fair resource allocation

## Run of Show

1. Motivation: Why spatial access is important
...
# Read DC libraries from GeoJSON
# Source: DC Open Data Portal
dc_libraries <- st_read("Libraries.geojson", quiet = TRUE)

tm_shape(st_transform(dc_boundary, 4326)) +
  tm_polygons(fill = "#e8f1f8", col = "#4a90d9", lwd = 2) +
tm_shape(dc_libraries) +
  tm_dots(size = 0.5, col = "#c41e3a") +
tm_title("Point locations of DC public libraries") +
...
![](qr_code.jpg){width=400 fig-align="center"}
